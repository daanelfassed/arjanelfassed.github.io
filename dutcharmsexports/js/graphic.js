...
$(document).ready(function() {
    ...
    function writeTable(data){
        ...
        $('#graphic').html('<div class="well"><table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dt-responsive nowrap" id="mySelection"></table></div>');
